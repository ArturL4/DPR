...
with st.echo(code_location='below'):
    mean_1 = st.slider("Number of points in spiral", 0.25, -5.0, 5.0)
    variance_1 = st.slider("Number of turns in spiral", 0.1, 1.0, 10.0)
    ...
    fig, ax = plt.subplots()
    ax.plot(X_AXIS,h_1, c="b")
    ax.plot(X_AXIS, h_2, c="orange")
    ...
    ax.vlines(X_AXIS[idx], -.01, max_val, color="r")
    st.write(fig)
