...
def two_moons_dataset(size, training_split):
    ...
    x2_banana1 = -0.3 * (x1_banana1 - 2)**2 + 4 + 0.7*np.random.normal(0, 1, size=size1)
    ...
    x2_banana2 = 0.3 * (x1_banana2 + 2)**2 - 4 + 0.7*np.random.normal(0, 1, size=size2)
...
def four_gaussian_dataset(size, training_split):
    ...
    data1 = np.random.normal((-2, -2), 1, size=(size1, 2))
    data2 = np.random.normal((-2, 2), 1, size=(size2, 2))
    data3 = np.random.normal((2, 2), 1, size=(size3, 2))
    data4 = np.random.normal((2, -2), 1, size=(size4, 2))
...
def circular_dataset(size, training_split):
    ...
    data, labels = make_circles((size1, size2), factor=0,shuffle=False)
